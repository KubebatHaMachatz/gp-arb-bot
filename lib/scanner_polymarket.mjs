...
import { feeFnFor } from './adapters/polymarket.mjs';
 ...
 *
 * @param {{sets: ReadonlyArray<object>, store: object, cfg: object, nowMs: number}} args
 * @returns {Array<object>} one row per priced set, each carrying its per-leg detail
 */
export function scanSets({ sets, store, cfg, nowMs }) {
  const rows = [];
